...
class Tx_MhDirectory_Controller_CategoryController extends Tx_Extbase_MVC_Controller_ActionController {
	...
	public function indexAction() {
		...
		$this->view->assign('companies', $this->companyRepository->findAll(3));
	}
	 ...
	 */
	public function listAction($category = 1) {
		$this->view->assign('category', $this->categoryRepository->findByUid(intval($category)));
		$this->view->assign('companies', $this->companyRepository->findByCategory(intval($category)));
	}
